...
def load_sentiment_model():
    try:
        ...
        model_name = "typeform/distilbert-base-uncased-mnli"  # Smaller, faster model
        pipe = pipeline(
                ...
                if len(journal.split()) < 10:
                    ...
                    if sentiment_model:
                        try:
                            ...
                            result = sentiment_model(journal.strip(), candidate_labels=labels)
                            sentiment = result["labels"][0].upper()
